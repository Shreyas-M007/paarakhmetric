    ...
    <body>
      ...
      <div class="footer">
        <div>
          ...
          <div style="font-size: 8.5px; color: #64748b; margin-top: 2px;">Digital Evidence Hash: SHA256-${activeInspection.id}-AUDIT-${Date.now().toString(36).toUpperCase()} · Team Encoders (github.com/Shreyas-M007)</div>
        </div>
